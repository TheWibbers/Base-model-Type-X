...
class patient_RegistrationForm(FlaskForm):
    ...
    patient_confirm_password = StringField('Confirm Password', validators=[DataRequired(),EqualTo('Password')])
...
class doctor_RegistrationForm(FlaskForm):
    ...
    doctor_confirm_password = StringField('Confirm Password', validators=[DataRequired(),EqualTo('Password')])
    doctor_code = StringField('Your Personal Identity Code', validators=[DataRequired()])
    submit = SubmitField('Sign Up')
